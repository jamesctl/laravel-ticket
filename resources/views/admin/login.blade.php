                                    ...
                                    <div
                                        ...
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2">{{ trans('general.welcomeBack') }}</h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-50">
                                                    <label class="text-bold-600"
                                                        for="login-username">{{ trans('general.email') }} </label>
                                                    {{ html()->text('username')->placeholder(__('general.emailAddress'))->class('form-control') }}
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="checkbox checkbox-sm">
                                                            {{-- {!! Form::checkbox('remember', true, false, ['class' => 'form-check-input' , 'id' => 'rememberAdmin']) !!} --}}
                                                            {{ html()->checkbox('remember', true)->class('form-check-input')->id('rememberAdmin') }}

                                                            <label class="checkboxsmall"
                                                                for="rememberAdmin"><small>{{ trans('user.rememberMe') }}</small></label>
                                                        </div>
                                                    </div>
                                                    <!--<div class="text-right"><a href="{{ url('forgot-password') }}"
                                                            class="card-link"><small>{{ trans('user.youForgotPassword') }}?</small></a>
                                                    </div>-->
                                                </div>
                                                <button type="submit"
                                                    class="btn btn-primary glow w-100 position-relative authentication-login-button"
                                                    href="javascript:void(0)">{{ trans('general.login') }}<i
                                                        id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                                {{ html()->form()->close() }}

                                                <hr>
                                                <div class="text-center"><small
                                                        class="mr-25">{{ trans('user.dontHaveAccount') }}?</small><a
                                                        href="{{ url('register') }}"><small>{{ trans('general.register') }}</small></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
