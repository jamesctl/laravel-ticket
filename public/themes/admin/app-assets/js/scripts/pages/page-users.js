...
$(document).ready(function () {
    ...
    // page users list module filter
    $("#users-list-module").on("change", function () {
        var usersModuleSelect = $("#users-list-module").val();
        // console.log(usersModuleSelect);
        usersTable.search(usersModuleSelect).draw();
    });
